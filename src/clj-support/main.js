...
exports.setup = function($tw) {
    ...
    $tw.utils.registerFileType("application/clojure","utf8",[".clj",".cljs",".cljc"],{deserializerType:"application/edn"});
    ...
    $tw.modules.define("$:/boot/tiddlerdeserializer/edn","tiddlerdeserializer",{
        "application/edn": function(text,fields) {
            ...
            fields.text = text;
            fields.type = fields.type || (filename.endsWith(".edn") ? "application/edn" : "application/clojure");
            return [fields];
        }
    });
};
